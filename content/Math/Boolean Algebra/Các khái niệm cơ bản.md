...
Biểu diễn hàm $\displaystyle f$ theo tập $\displaystyle Supp( f)$ của nó tức là ta sẽ biểu diễn thông qua một tập hợp chứa các vector đầu vào mà tại đó $\displaystyle f( x) =1$. Cách biểu diễn này hiệu quả đối với những hàm có Hamming weight thấp.
