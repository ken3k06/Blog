...
Các máy ảo sẽ sử dụng Hypervisor để giả lậpphần cứng. Mỗi Hypervisor cho phép mỗi một máy ảo hoặc khách truy cập vào các lớp tài nguyên vật lý bên dưới, bao gồm CPU, bộ nhớ lưu trữ hoặc RAM.
